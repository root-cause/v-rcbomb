...
namespace RCBomb
{
    public static class HelpTextKeys
    {
        // credits to UnknownModder, https://pastebin.com/HwYykxZE
        enum ControlEnum
        {
            INPUT_NEXT_CAMERA,
            INPUT_LOOK_LR,
        ...
        public static string Get(int control)
        {
            return $"~{Enum.GetName(typeof(ControlEnum), control)}~";
        }
    }
}